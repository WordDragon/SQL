-----------------------------------------------------------------------------------------------------------------------------------------
-- CREA SP spBuscarUsuario
-- VER. AUTOR   :     Darwin Cantuta Zegobia
-- VER. FECHA   :     2018 - Julio - 12
-- VER. DESCR   :     Procedimiento almacenado "spBuscarUsuario" el cual busca el usuario para autenticar el acceso al sistema
-----------------------------------------------------------------------------------------------------------------------------------------

--USE LABIC

--EXEC spBuscarUsuario 'darwin','12345'

IF EXISTS (SELECT * FROM sys.objects WHERE type = 'P' AND name = 'spBuscarUsuario')
...
AS BEGIN
	...
	-- DECLARA VARIABLES
	DECLARE @strNombreSP VARCHAR(200) = 'spBuscarUsuario - ' + ISNULL(@usrId,'');
